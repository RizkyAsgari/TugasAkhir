    ...
    <div class="block xl:grid grid-cols-2 gap-4">
      ...
      <div class="hidden xl:flex flex-col min-h-screen">
        <a href="/app" class="-intro-x flex items-center pt-5">
          ...
          <span class="text-white text-lg ml-3"> FM Shop </span>
        </a>
        <div class="my-auto">
          ...
          <div class="-intro-x mt-5 text-lg text-white text-opacity-70 dark:text-slate-400">Menjual Alat-Alat Video Grafer</div>
        </div>
      </div>
      <!-- END: Login Info -->
      <!-- BEGIN: Login Form -->
